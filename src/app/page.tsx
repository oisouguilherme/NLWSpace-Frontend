...
export default function Home() {
  return (
    <main className={`${roboto.variable} ${baiJamjuree.variable} font-sans grid grid-cols-2 min-h-screen`}>
      <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
        ...
        <div className=" space-y-5">
          ...
          <div className="max-w-[420px] space-y-1">
            <h1 className="mt-5 text-4xl font-bold text-gray-50 leading-tight font-alt">Sua cápsula do tempo</h1>
            <p className="text-lg leading-relaxed">Colecione momentos marcantes da sua jornada e compartilhe (se quiser) com o mundo!</p>
          </div>
          <a className="inline-block rounded-full bg-green-500 hover:bg-green-600 py-3 px-5 text-sm leading-none text-black font-alt font-medium" href="#">CADASTRAR LEMBRANÇA</a>
        </div>
